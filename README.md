...
Kelsey’s branch, however the "Salary_ML_Model_Score_Milestones_Notes.xlsx" file contains notes about key milestones in the creation of the salaries machine learning model.
...
-Referenced to learn about hyperarameters in ML:
https://towardsdatascience.com/hyperparameter-tuning-the-random-forest-in-python-using-scikit-learn-28d2aa77dd74
https://www.youtube.com/watch?v=SctFnD_puQI-Referenced to learn about TensorFlow ML (final models do not use this information):
